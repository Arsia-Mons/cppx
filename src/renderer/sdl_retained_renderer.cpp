...
SDL_Color to_sdl_color(::ui::Color color) {
  return {color.r, color.g, color.b, color.a};
}

SDL_FRect to_sdl_rect(::ui::Rect rect) {
  return {rect.x, rect.y, rect.width, rect.height};
}

void set_draw_color(SDL_Renderer *renderer, ::ui::Color color) {
...
void SdlRetainedRenderer::clear(::ui::Color background) {
  if (!renderer_)
    return;
