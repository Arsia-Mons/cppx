...
src/ui/...         # generic retained UI toolkit: hooks runtime, focus, primitives
...
src/react.{h,cpp}  # React-style hook runtime (see src/react.h header)
